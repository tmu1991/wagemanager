...
public interface HiSalaryService {
    ...
    List<HiSalary> findByDeptIdAndDete(String deptId, int year, int month, PageRequest page);
    Integer countByDeptIdAndDate(String deptId, int year, int month);
    List<HiSalary> findByYearAndMonth(int year, int month, PageRequest page);
