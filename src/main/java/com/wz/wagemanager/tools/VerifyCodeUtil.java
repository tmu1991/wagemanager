...
//http://www.ndrc.gov.cn/zcfb/zcfbtz/201606/t20160601_806201.html 关于印发《能源技术革命创新行动计划（2016-2030年）》的通知
    public static void main (String[] args) throws IOException {
        outputVerifyImage(78,25,new File("e://1.jpg"),4);
    }
    ...
    public static BufferedImage getImage(int w, int h, String code){
        ...
        g2.setColor(getRandColor(30, 160));
        int fontSize = h-4;
